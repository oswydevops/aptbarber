...
├── layouts/          # Hero, secciones principales
...
# Subir/Eliminar
galeria.subir_imagen(file_object)
galeria.eliminar_imagen('nombre.jpg')

# Verificar capacidad
puede_subir = galeria.puede_subir_imagenes(3)
```
...
user = AuthService.validar_credenciales('admin', 'password')

# Crear usuario
user = AuthService.crear_usuario('nuevo_user', 'password')
```
...
- [REFACTOR_SUMMARY.md](REFACTOR_SUMMARY.md) - Resumen de cambios
- [RESPONSIVE_UPDATES.md](RESPONSIVE_UPDATES.md) - Actualizaciones responsive
